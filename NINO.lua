...
local stab1 = page7:addSection("Character")
...
section1:addToggle("Auto Farm Level", false, function(a)
    while _G.AUTOFARM do wait()
      ...
      local MyLevel = game:GetService("Players").LocalPlayer.Data.Level.Value
        ...
        if MyLevel >= 1825 and MyLevel <= 1849 then
...
spawn(function()
    while wait() do
        if _G.AUTOKILL then
            ...
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[Select].Character.HumanoidRootPart.CFrame * CFrame.new(2,0,0)
            click()
        end
    end
end)
